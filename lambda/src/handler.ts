...
import { listCities, getCity, getSample, getTopSearched, getRecentSearched, recordSearch } from './routes/cities'
...
const ROUTES: Route[] = [
  ...
  { method: 'GET',  pattern: /^\/cities\/sample$/,             keys: [],       handler: getSample },
